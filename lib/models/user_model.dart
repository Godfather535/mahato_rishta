...
class UserModel extends Model {
  ...
  Future<void> signUp({
    ...
    required String ancestralState,
    required String ancestralVillage,
    required String numberOfBrothers,
    required String numberOfSisters,
    // Callback functions
    ...
    await _firestore
      ...
      USER_FATHER_NAME: fathersName,
      USER_MOTHER_NAME: mothersName,
      USER_RELIGION: userReligion,
      USER_CASTE: caste,
      USER_SUBCASTE: subCaste,
      USER_GOTHRA: gothra,
      USER_ANCESTRAL_VILLAGE: ancestralVillage,
      USER_ANCESTRAL_STATE: ancestralState,
    }).then((_) async {
      /// Get current user in database
