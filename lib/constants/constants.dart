...
const String ANDROID_INTERSTITIAL_ID = "ca-app-pub-8102567131124521~6941513993";
// For IOS Platform
...
///DATABASE FIELDS FOR User's family details
///
const String USER_FATHER_NAME = "user_father_name";
const String USER_MOTHER_NAME = "user_mother_name";
const String USER_RELIGION = "user_religion";
const String USER_CASTE = "user_caste";
const String USER_SUBCASTE = "user_subscaste";
const String USER_GOTHRA = "user_gothra";
const String USER_ANCESTRAL_VILLAGE = "user_ancestral_village";
const String USER_ANCESTRAL_STATE = "user_ancestral_state";
const String USER_NUMBER_OF_BROTHERS = "user_no_of_brothers";
const String USER_NUMBER_OF_SISTERS = "user_no_of_sisters";
